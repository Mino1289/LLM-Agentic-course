...
export function AppShell() {
  ...
  const artifactLabels = {
    ...
    priceCharts: tArtifacts("priceCharts"),
    pricePerformance: tArtifacts("pricePerformance"),
    priceVolatility: tArtifacts("priceVolatility"),
    priceDrawdown: tArtifacts("priceDrawdown"),
    priceCurrent: tArtifacts("priceCurrent"),
