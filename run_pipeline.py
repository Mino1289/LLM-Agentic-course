...
def main() -> None:
    ...
    parser.add_argument("--download", action="store_true", help="Forcer le téléchargement SEC")
    ...
    parser.add_argument("--sections", default="1a,7", help="Sections à extraire (défaut: 1a,7)")
    parser.add_argument("--strategy", default="semantic", help="Stratégie de chunking (défaut: semantic)")
    parser.add_argument("--batch-size", type=int, default=64, help="Taille de batch embedding")
    parser.add_argument("--rpm", type=int, default=120, help="Rate limit embeddings (req/min)")
    parser.add_argument("--dry-run", action="store_true", help="Affiche le plan sans exécuter")
    parser.add_argument("--skip-download", action="store_true", help="Ignorer le téléchargement même si --download")
    ...
    print(f"{'=' * 70}")
    print(f"\n  Lance l'interface :")
    print(f"    streamlit run ui/app_rag.py")
