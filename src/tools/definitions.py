            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "tickers": {"type": "array", "items": {"type": "string"}, "description": f"Optional tickers: {_tracked_tickers_text()}."},
                        "years": {"type": "array", "items": {"type": "string"}, "description": "Optional filing years, e.g. ['2024']."},
                        "doc_types": {"type": "array", "items": {"type": "string"}, "description": "Optional: 10-K, 10-Q, 8-K, 20-F, 6-K, EARNINGS_CALL."},
                    },
                    "required": ["query"],
                },
            },
        },
        {
            ...
            "function": {
                ...
                "parameters": {
                    "type": "object",
                    "properties": {
                        "tickers": {"type": "array", "items": {"type": "string"}, "description": "Tickers to fetch."},
            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "format": {"type": "string", "enum": ["md", "pdf"], "description": "Output format."},
                    },
        ...
        },
        {
            ...
            "function": {
                ...
                "parameters": {
                    "type": "object",
                    "properties": {
                        "ticker": {"type": "string", "description": f"Ticker: {_tracked_tickers_text()}."},
                        "side": {"type": "string", "enum": ["buy", "sell"], "description": "Buy or sell."},
                        "qty": {"type": "number", "description": "Number of shares."},
                        "order_type": {"type": "string", "enum": ["market", "limit", "stop", "stop_limit"], "description": "Default: market."},
        ...
        },
        {
            ...
            "function": {
                ...
                "parameters": {
                    "type": "object",
                    "properties": {
                        "ticker": {"type": "string", "description": "Ticker to close (empty if all=true)."},
                        "all": {"type": "boolean", "description": "Liquidate all positions."},
                    },
                },
            },
        },
        ...
        },
        {
            ...
            "function": {
                ...
                "parameters": {
                    "type": "object",
                    "properties": {
                        "period": {"type": "string", "description": "1D, 1W, 1M (default), 1A."},
                        "timeframe": {"type": "string", "description": "1Min, 5Min, 15Min, 1H, 1D."},
                        "extended_hours": {"type": "boolean", "description": "Include extended hours."},
                    },
                },
            },
        },
        {
            ...
            "function": {
                ...
                "parameters": {
                    "type": "object",
                    "properties": {
                        "activity_types": {"type": "array", "items": {"type": "string"}, "description": "Filter: FILL, DIV, CSD, CSW, INT, FEE, etc."},
                        "date": {"type": "string", "description": "Date YYYY-MM-DD."},
                        "after": {"type": "string", "description": "After YYYY-MM-DD."},
                        "until": {"type": "string", "description": "Before YYYY-MM-DD."},
                        "page_size": {"type": "integer", "description": "Max entries (default 20, max 100)."},
