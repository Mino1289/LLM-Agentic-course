...
from src.rag.types import DEFAULT_DAILY_EMBEDDING_LIMIT, DEFAULT_EMBEDDING_RPM, DEFAULT_EMBEDDING_BATCH_SIZE, DEFAULT_EMBEDDING_RETRIES
...
def main():
    ...
    parser.add_argument("--plan", action="store_true", help="Afficher le nombre de chunks et le quota sans embedder.")
    parser.add_argument("--embed", action="store_true", help="Lancer les embeddings (respecte le quota restant).")
    ...
    parser.add_argument("--rpm", type=int, default=int(os.getenv("EMBEDDING_RPM", str(DEFAULT_EMBEDDING_RPM))))
    parser.add_argument("--batch-size", type=int, default=int(os.getenv("EMBEDDING_BATCH_SIZE", str(DEFAULT_EMBEDDING_BATCH_SIZE))))
    parser.add_argument("--retries", type=int, default=int(os.getenv("EMBEDDING_MAX_RETRIES", str(DEFAULT_EMBEDDING_RETRIES))))
